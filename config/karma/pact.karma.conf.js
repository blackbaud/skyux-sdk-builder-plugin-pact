...
function getConfig(config) {
  ...
  require('@skyux-sdk/builder/config/karma/test.karma.conf')(config);

  let skyPagesConfig = require('@skyux-sdk/builder/config/sky-pages/sky-pages.config').getSkyPagesConfig(argv._[0]);
  let testWebpackConfig = require('@skyux-sdk/builder/config/webpack/test.webpack.config');
